...
/**
 * Item Model for admission.
 *
 * @package     Mehrdarman_admission
 * @subpackage  Models
 */
class Mehrdarman_admissionModelAdmission extends JModelAdmin
{
	/**
	 * @var        string    The prefix to use with controller messages.
	 * @since   1.6
	 */
	protected $text_prefix = 'COM_MEHRDARMAN_ADMISSION';
	 ...
	 * @since    3.2
	 */
	public $typeAlias = 'com_mehrdarman_admission.admission';
	 ...
	 */
	public function getTable($type = 'Admission', $prefix = 'Mehrdarman_admissionTable', $config = array())
	{
	...
	public function hit($pk = 0)
	{
		...
		if ($hitcount)
		{
			$pk = (!empty($pk)) ? $pk : (int) $this->getState('admission.id');
